(function () {
    ...
    function getOutFields(dklx) {
        ...
        switch (dklx) {
            /*
            case '空闲地块':
                qFields = landQueryConfigs.xztd.queryFields;
                break;*/
            case '规划地块':
    ...
    function getUrl(dklx) {
        switch (dklx) {
            /*
            case '空闲地块':
                return 'http://' + globalIP + ':6080/arcgis/rest/services/XQ/XQ_XZTD/MapServer/0';
            */
            case '规划地块':
            ...
            case '工业厂房':
                return 'http://' + globalIP + ':6080/arcgis/rest/services/XQ/XQ_XZCF/MapServer/0';
            default:
                return null;
        }
    }
