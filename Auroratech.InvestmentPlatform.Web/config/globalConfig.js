...
var landQueryConfigs =
    {
        ...
        xzcf: {
            queryFields: { "OBJECTID": "ID", "BSM": "标识码", "LX": "类型", "CFMC": "名称", "DKWZ": "位置", "JZMJ": "建筑面积_平方米", "JZMJ_W": "建筑面积_万平方米", "XZMJ": "闲置面积", "XZMJ_W": "闲置面积_万平方米", "YZMJ": "已租面积", "BFLX": "标房类型", "BFZT": "标房状态", "SSJD": "所属街道" },
            displayFields: { "LX": "类型", "CFMC": "名称", "DKWZ": "位置", "JZMJ": "建筑面积_平方米", "JZMJ_W": "建筑面积_万平方米", "XZMJ": "闲置面积", "XZMJ_W": "闲置面积_万平方米", "YZMJ": "已租面积", "BFLX": "标房类型", "BFZT": "标房状态", "SSJD": "所属街道" },
            displayField: '名称',
            tableName: 'xzcf',
            sheetName: '标准厂房'
        },
        zsdk: {
            queryFields: { "OBJECTID": "ID", "BSM": "标识码", "DKBH": "地块编号", "TDYT": "土地用途", "TDMJ": "土地面积_平方米", "TDMJ_M": "土地面积_亩" },
        ...
        pewg: {
            queryFields: { "OBJECTID": "ID", "BSM": "标识码", "DKH": "地块号", "XMMC": "项目名称", "YDDW": "用地单位", "TDZL": "土地坐落", "TDYT": "土地用途", "PZWH": "批准文号", "SSXZQMC": "行政区划", "PZSJ": "批准时间", "TDMJ": "土地面积_平方米", "TDMJ_M": "土地面积_亩", "BZ": "备注" },
        ...
        yebz: {
            queryFields: { "OBJECTID": "ID", "BSM": "标识码", "QLRMC": "权利人名称", "YDDW": "用地单位", "XZMJ": "空置面积_平方米", "XZMJ_M": "空置面积_亩", "TDMJ": "土地面积_平方米", "TDMJ_M": "土地面积_亩", "TDYT": "土地用途", "TDZL": "土地坐落", "SSYQ": "所属园区", "SSXZ": "所属乡镇" },
            displayFields: { "QLRMC": "权利人名称", "YDDW": "用地单位", "XZMJ": "空置面积_平方米", "XZMJ_M": "空置面积_亩", "TDMJ": "土地面积_平方米", "TDMJ_M": "土地面积_亩", "TDYT": "土地用途", "TDZL": "土地坐落", "SSYQ": "所属园区", "SSXZ": "所属乡镇" },
            displayField: '用地单位',
            tableName: 'yebz',
            sheetName: '用而不足'
        },
        ...
        kjzt: {
            queryFields: { 'OBJECTID': 'ID', 'BSM': '标识码', 'YQMC': '园区名称', 'DZ': '地址', "JZMJ": "建筑面积_平方米", "JZMJ_W": "建筑面积_万平方米", "XZMJ": "闲置面积", "XZMJ_W": "闲置面积_万平方米", 'YZMJ': '已租面积' },
            displayFields: { 'YQMC': '园区名称', 'DZ': '地址', "JZMJ": "建筑面积_平方米", "JZMJ_W": "建筑面积_万平方米", "XZMJ": "闲置面积", "XZMJ_W": "闲置面积_万平方米", 'YZMJ': '已租面积' },
            displayField: '园区名称',
            tableName: 'kjzt',
            sheetName: '科技载体'
        }
