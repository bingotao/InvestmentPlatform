<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage/MasterBase.Master" AutoEventWireup="true" CodeBehind="PlatformMap.aspx.cs" Inherits="Auroratech.InvestmentPlatform.pages.PlatformMap" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptFilePlaceHolder" runat="server">
    ...
    <script src="../js/auroratech/base/com.js"></script>
