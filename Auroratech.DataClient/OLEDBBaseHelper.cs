...
{
  public class OLEDBBaseHelper : IBaseOperator, IDisposable
  {
    private IOLEDBSqlFactory factory;

    public IOLEDBSqlFactory Factory
    {
      get
      {
    ...
    public DataSet ExecuteQuery(IDbProvider provider, string sqlString)
    {
      ...
      OleDbDataAdapter oleDbDataAdapter = new OleDbDataAdapter(provider.Command as OleDbCommand);
      DataSet dataSet = new DataSet();
      oleDbDataAdapter.Fill(dataSet);
      OleDbParameter oleDbParameter = new OleDbParameter("myreturn", OleDbType.Integer);
      oleDbParameter.Direction = ParameterDirection.ReturnValue;
      provider.Command.Parameters.Add((object) oleDbParameter);
