...
{
  public interface IOLEDBSqlFactory : IDisposable
  {
    ...
    IDataParameter CreateParameter(string name, OLEDBDataType type, object value);

    IDataParameter CreateParameter(string name, OLEDBDataType type, int size);

    IDataParameter CreateParameter(string name, OLEDBDataType type, int size, object value);

    IDataParameter CreateParameter(string name, OLEDBDataType type);
  }
}
